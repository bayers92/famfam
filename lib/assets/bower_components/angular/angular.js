 ...
 *
 * ```js
 * var famfam = angular.module('famfam', []);
 * famfam.run(function($templateCache) {
 ...
 *
 * ```
 *  angular.module('famfam', []).config(function($sceDelegateProvider) {
 ...
 *
 * ```
 * angular.module('famfamWithSceDisabledfamfam', []).config(function($sceProvider) {
