...
<head>
    ...
    <script>
        var famfam = angular.module('famfam', ['ui.router']);
        // For Component users, it should look like this:
        // var famfam = angular.module('famfam', [require('angular-ui-router')]);
    </script>
    ...
</head>
<body>
...
>
```javascript
famfam.config(function($stateProvider, $urlRouterProvider) {
  //
...
>
```javascript
famfam.config(function($stateProvider) {
  $stateProvider
    .state('index', {
      url: "",
      views: {
